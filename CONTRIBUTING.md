...
| One paged screen (Event/VM/Screen; Paging 3 owns load/error/retry state — [ADR-0024](docs/DECISIONS.md#adr-0024)) | `:feature:feed` | `src/commonMain/kotlin/…/presentation/<name>/`, strings in `src/commonMain/composeResources/` |
...
| `main()` — the desktop entry point only | `:desktopApp` | `src/jvmMain/kotlin/…/` |
